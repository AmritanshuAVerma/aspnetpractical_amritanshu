...
namespace aspnetpracticalWeb.Controllers
{
    public class AlbumsController : Controller
    {
        private readonly aspnetpracticalWebContext _context;

        public AlbumsController(aspnetpracticalWebContext context)
        {
            _context = context;
        }
        ...
        {
            var aspnetpracticalWebContext = _context.Album.Include(a => a.Artist);
            return View(await aspnetpracticalWebContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'aspnetpracticalWebContext.Album'  is null.");
            }
            var album = await _context.Album.FindAsync(id);
            if (album != null)
            {
